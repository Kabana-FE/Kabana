// request.ts는 작업중이라 이번 리뷰에서는 제외해주세요.
...
//  *
//  * @param endpoint - 요청할 API 경로
//  * @param data - 요청 본문 (JSON 또는 FormData)
//  * @param options - 추가 설정 (headers 등)
//  * @returns 서버 응답 데이터
//  */
// export const requestPost = async <T>(endpoint: string, data: unknown, options?: AxiosRequestConfig): Promise<T> => {
...
//  * @returns 서버 응답 데이터
//  */
// export const requestPut = async <T>(endpoint: string, data: unknown, options?: AxiosRequestConfig): Promise<T> => {
...
//  * @returns 서버 응답 데이터
//  */
// export const requestPatch = async <T>(endpoint: string, data: unknown, options?: AxiosRequestConfig): Promise<T> => {
