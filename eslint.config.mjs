...
export default tseslint.config(
  // 1. 전역 ignore 설정 (.eslintignore 대체)
  {
    ignores: ['dist', 'node_modules', 'eslint.config.mjs', 'postcss.config.mjs', 'commitlint.config.mjs'],
  },

  // 2. 기본 JavaScript recommended 룰 적용
  eslint.configs.recommended,

  // 3. TypeScript용 plugin + parser + 규칙 설정
  {
    plugins: {
  ...
  // 4. JS 파일에서는 type-aware linting 비활성화
  {
    files: ['**/*.js'],
    extends: [tseslint.configs.disableTypeChecked],
  },

  // 5. Prettier 관련 룰 비활성화
